...
const start_qz_btn = document.querySelector(".start-quiz");
...
function generate_quiz() {
  ...
  const progress_dlog = document.querySelector(".progress-dlog");
  ...
  totalQuestions = noofqstns.value;//Globel variable declared in aiquiz
...
start_qz_btn.addEventListener("click", startQuiz);
